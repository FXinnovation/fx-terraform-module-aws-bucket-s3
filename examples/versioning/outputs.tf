...
output "id" {
  ...
  value       = "${module.versioning.id}"
}

output "arn" {
  description = "The ARN of the bucket. Will be of format arn:aws:s3:::bucketname."
  value       = "${module.versioning.arn}"
}

output "bucket_domain_name" {
  description = "The bucket domain name. Will be of format bucketname.s3.amazonaws.com."
  value       = "${module.versioning.bucket_domain_name}"
}

output "bucket_regional_domain_name" {
  description = "The bucket region-specific domain name. The bucket domain name including the region name."
  value       = "${module.versioning.bucket_regional_domain_name}"
}

output "hosted_zone_id" {
  description = "The Route 53 Hosted Zone ID for this bucket's region."
  value       = "${module.versioning.hosted_zone_id}"
}

output "region" {
  description = "The AWS region this bucket resides in."
  value       = "${module.versioning.region}"
}
